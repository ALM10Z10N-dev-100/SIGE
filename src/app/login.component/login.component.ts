...
export class LoginComponent {
  ...
  camposRegistro: CampoFormulario[] = [
    { nombre: 'nombre', tipo: 'text', placeholder: 'Nombre(s)', icono: 'assets/img/logIn/user.svg', requerido: true },
    { nombre: 'apellidoPaterno', tipo: 'text', placeholder: 'Apellido Paterno', icono: 'assets/img/logIn/user.svg', requerido: true },
    { nombre: 'apellidoMaterno', tipo: 'text', placeholder: 'Apellido Materno', icono: 'assets/img/logIn/user.svg', requerido: true },
    { nombre: 'telefono', tipo: 'tel', placeholder: 'Teléfono (10 dígitos)', icono: 'assets/img/logIn/phone.svg', requerido: true }
  ];
